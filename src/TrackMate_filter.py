...
DAPI_Timelapse_folder = r'F:\Experiments\Timelapse_datasets\20190329_MDCKII_FUCCI_Hoescht_62h\DAPI/'

# Path to the tracking csv file 'Spots in tracks statistics.csv' generated by TrackMate.
csv_p = r"F:\Experiments\Timelapse_datasets\20190329_MDCKII_FUCCI_Hoescht_62h\Spots in tracks statistics.csv"

# Path of the track curation folder which will contain the visualization of the tracks with a potential cell division.
track_curation_folder = r'F:\Experiments\Timelapse_datasets\20190329_MDCKII_FUCCI_Hoescht_62h\track_curation/'
